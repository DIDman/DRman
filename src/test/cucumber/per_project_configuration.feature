Feature: Per-project configuration
	...
	Scenario: The env command is issued without an drman project configuration present
		Given the system is bootstrapped
		When I enter "drmenv"
		Then I see "No .drmanrc file found."
		And I see "Please create one before using this command."
		And the exit code is 1

	Scenario: The env command is issued with an drman project configuration present
		Given the file ".drmanrc" exists and contains "groovy=2.4.1"
