...
anything else unless it is an actual error.
	...
	Scenario: Home for a candidate version that is installed
		...
		When I enter "drm home grails 1.3.9"
		Then the home path ends with ".drman/candidates/grails/1.3.9"
	...
	Scenario: Home for a candidate version that does not exist
		...
		And the system is bootstrapped
		When I enter "drm home groovy 1.9.9"
	...
	Scenario: Home for a candidate version that only exists locally
		...
		And the system is bootstrapped
		When I enter "drm home grails 2.0.0.M1"
		Then the home path ends with ".drman/candidates/grails/2.0.0.M1"
